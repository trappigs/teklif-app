...
import { Check, FileCheck, ShieldCheck, Map, Footprints, Gem, User, Phone, BadgePercent } from 'lucide-react';
...
export default async function SharedProposalPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-stone-100 py-8 md:py-12 print:py-0 print:bg-white text-black flex justify-center">
      {/* Proposal Document */}
            ...
            return (
              <div key={index} className="break-inside-avoid">
                <div className="flex flex-col md:flex-row gap-8 mb-8 border-b md:border-b-0 pb-8 md:pb-0 border-stone-100 last:border-0 last:pb-0">
                    <div className="w-full md:w-1/3 h-64 md:h-56 rounded-2xl overflow-hidden border border-stone-200 shrink-0 shadow-sm bg-stone-50">
                      <img 
                        ...
                        <table className="w-full text-left table-fixed">
                          ...
                          <tbody className="divide-y divide-stone-100 text-[10px] md:text-sm">
                            ...
                            <tr className="bg-brand-light/5">
                              ...
                              <td className="py-3 px-2 md:px-4 text-right font-bold whitespace-nowrap text-brand-dark text-[9px] md:text-sm">Nakit</td>
                            </tr>
                            {/* Option 1 */}
                            {item.option1?.price > 0 && (
                              <tr>
                                <td className="py-3 px-2 md:px-4 font-bold text-stone-700 text-[9px] md:text-sm">12 AY</td>
                            ...
                            {item.option2?.price > 0 && (
                              <tr>
                                <td className="py-3 px-2 md:px-4 font-bold text-stone-700 text-[9px] md:text-sm">24 AY</td>
